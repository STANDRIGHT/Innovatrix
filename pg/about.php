      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="single-service text-center">
            ...
            <p>We design for four corners and ensure your website will look beautiful on any of today’s internet connected devices.</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-4">
          <div class="single-service text-center">
            ...
            <div class="faqs">
              <div id="faqs">
                <div class="single-faq">
                  <h2 class="faq-heading" id="faq-heading1" data-bs-toggle="collapse" data-bs-target="#collapse1"
                    aria-expanded="true" aria-controls="collapse1">
                    What is the best way to give a PowerPoint presentation?
                  </h2>
                  <div id="collapse1" class="accordion-collapse collapse show" aria-labelledby="faq-heading1"
                    data-bs-parent="#faqs">
                    <p>
                ...
                <div class="single-faq">
                  <h2 class="faq-heading collapsed" id="faq-heading2" data-bs-toggle="collapse"
                ...
                <div class="single-faq">
                  <h2 class="faq-heading collapsed" id="faq-heading3" data-bs-toggle="collapse"
                ...
                <div class="single-faq">
                  <h2 class="faq-heading collapsed" id="faq-heading4" data-bs-toggle="collapse"
                    data-bs-target="#collapse4" aria-expanded="false" aria-controls="collapse4">
                    How can I be the next Mark Zuckerberg or Bill Gates?
                  </h2>
                  <div id="collapse4" class="accordion-collapse collapse" aria-labelledby="faq-heading4"
                    data-bs-parent="#faqs">
                    <p>
                      When it comes to business, listen to Henry David
                      Thoreau: things usually don’t happen overnight –
