      ...
      <div class="col-lg-6">
        <div class="mr50">
          <div class="heading2 no-margin-heading">
            <small class="heading-top inner-heading-top"><img src="assets/img/icons/hands.svg" alt="" />Digital Strategies</small>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="single-service-advise">
                ...
                <h4 style="text-align:center;">UI/UX Strategy</h4>
                <p>A portion of our time is spent consulting for companies who may already have an app but need help developing the right strategy for their users.</p>
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="single-service-advise">
                ...
                <h4 style="text-align:center;">Industry Standard Practices</h4>
                <p>We dedicate part of our time each week reading and learning about new techniques and industry best practices.</p>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="single-service-advise">
                ...
                <h4 style="text-align:center;">Blending Beauty & Performance</h4>
            ...
            <div class="col-lg-6">
              <div class="single-service-advise">
                ...
                <h4 style="text-align:center;">Design Agnostic Designs</h4>
                <p>Our goal is to focus on designs that transcend device screen size and look beautiful on a variety of screens.</p>
              </div>
            </div>
          </div>
