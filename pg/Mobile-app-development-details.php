    ...
    <div class="row align-items-center">
      <div class="col-lg-6">
        <div class="mr50">
          <div class="heading2 no-margin-heading">
            <small class="heading-top inner-heading-top"><img src="assets/img/icons/hands.svg" alt="" />Mobile Development</small>
            <h2>Most businesses are going mobile, we wont allow yours to miss out.</h2>
            <p>Amazing Mobile App Experiences for All Platforms</p>
      ...
      <div class="col-lg-6 mobile-hidden">
        <div class="about-bg-main-img position-relative ml50">
          <img class="border-radius" src="assets/img/services/device.png" alt="mobial-app-image" />
